    ...
    return Form(
      ...
      child: Scaffold(
        body: SingleChildScrollView(
          child: Padding(padding: EdgeInsets.only(top: 80, left: 16, right: 16),
          child: Column(
            ...
            children: [
              ...
              Text(BaroTexts.registerTitle, style: GoogleFonts.plusJakartaSans(textStyle: TextStyle(fontSize: 24, fontWeight: FontWeight.w700, color: Color(0xFF3D3D3D)))),
              const SizedBox(height: 4,),
              Text(BaroTexts.registerDesc, style: GoogleFonts.plusJakartaSans(textStyle: TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Color(0xFF3D3D3D))),),
              ...
              TextFormField(
                ...
                style: GoogleFonts.plusJakartaSans(textStyle: TextStyle(fontSize: 14)
                ),
              ),
              const SizedBox(height: 16,),
              ...
              Row(
                ...
                children: [
                  Text("Sudah memiliki akun?", style: GoogleFonts.plusJakartaSans(textStyle: TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Color(0xFF3D3D3D))),),
                  TextButton(onPressed: () => Get.toNamed(Routes.LOGIN), child: Text("Masuk", style: GoogleFonts.plusJakartaSans(textStyle: TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: Color(0xFFE82027))),)),
                ],
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
