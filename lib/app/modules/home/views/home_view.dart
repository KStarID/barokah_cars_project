...
import 'package:barokah_cars_project/app/modules/home/views/widgets/product_card.dart';
              ...
              children: [
                ...
                Container(
                  ...
                  child: ListView(
                    ...
                    children: [
                      const BrandCustomCard(brand: 'Toyota', stock: '12', image: BaroImages.toyota,),
                      const SizedBox(width: 10,),
                      const BrandCustomCard(brand: 'Nissan', stock: '8', image: BaroImages.nissan,),
                      const SizedBox(width: 10,),
                      const BrandCustomCard(brand: 'Mercedez', stock: '6', image: BaroImages.mercedezBenz,),
                      const SizedBox(width: 10,),
                      const BrandCustomCard(brand: 'Lexus', stock: '11', image: BaroImages.lexus,),
                      const SizedBox(width: 10,),
                      const BrandCustomCard(brand: 'Toyota', stock: '12', image: BaroImages.toyota,),
                      const SizedBox(width: 10,),
                      const BrandCustomCard(brand: 'Nissan', stock: '8', image: BaroImages.nissan,),
                ...
                Container(
                  ...
                  child: ListView(
                    ...
                    scrollDirection: Axis.horizontal,
                    children: [
                      const ProductCustomCard(brand: 'Toyota', stock: '12', image: BaroImages.toyota,),
                      const SizedBox(width: 10,),
                      const ProductCustomCard(brand: 'Nissan', stock: '8', image: BaroImages.nissan,),
                      const SizedBox(width: 10,),
                      const ProductCustomCard(brand: 'Mercedez', stock: '6', image: BaroImages.mercedezBenz,),
                      const SizedBox(width: 10,),
                      const ProductCustomCard(brand: 'Lexus', stock: '11', image: BaroImages.lexus,),
                      const SizedBox(width: 10,),
                      const ProductCustomCard(brand: 'Toyota', stock: '12', image: BaroImages.toyota,),
                      const SizedBox(width: 10,),
                      const ProductCustomCard(brand: 'Nissan', stock: '8', image: BaroImages.nissan,),
