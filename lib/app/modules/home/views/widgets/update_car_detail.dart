          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text("Update Data", style: GoogleFonts.plusJakartaSans(textStyle: const TextStyle(fontSize: 20, fontWeight: FontWeight.w700, color: Colors.black)),),
                    ...
                    children: [
                      Center(
                        child: SizedBox(
                            ...
                            width: 150,
                            child: Obx(() {
                              return addCarController.selectedImage.value == null && addCarController.imageUrl.value.isEmpty
                                  ? IconButton(
                                      icon: const Icon(
                                  ...
                                  : MaterialButton(
                                      height: 100,
                                      child: addCarController.selectedImage.value != null 
                                          ? Image.file(
                ...
                BaroWidgetButton(
                  buttonName: "Update", 
                  onPressed: () async {
                    await addCarController.updateCarDetails(car['id']);
                    Get.to(() => HomeView());
                  }, 
